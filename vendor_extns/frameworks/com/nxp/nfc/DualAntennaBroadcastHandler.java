...
public class DualAntennaBroadcastHandler extends BroadcastReceiver {
    ...
    public static final String ACTION_CUSTOM_EVENT = "com.nxp.nfc.DualAntennaBroadcastHandler";
            ...
            switch (intent.getAction()) {
                case ACTION_CUSTOM_EVENT:
                    ...
                    if ("ANTENNA_CONFIG".equals(actionType)) {
                        ...
                        handleReaderModeConfiguration(
                                readerModeAntenna1Value, readerModeAntenna2Value);
    ...
    private void handleFlipEvent(String message, int value) {
        ...
        if (mDualAntennaHandler != null) {
            ...
            NxpNfcLogger.e(TAG, "DualAntenna handler is not initialized for flip event");
        }
    }

    private void handleAntennaConfiguration(int antennaOneValue, int antennaTwoValue) {
        // Process antenna configuration
        NxpNfcLogger.d(
                TAG,
                "Processing antenna configuration - Antenna1: 0x"
        ...
        if (mDualAntennaHandler != null) {
            try {
                mDualAntennaHandler.setDiscoveryTechnology_DualAntenna(
                        antennaOneValue, antennaTwoValue);
            } catch (Exception e) {
                NxpNfcLogger.e(TAG, "Exception in antenna configuration: " + e.getMessage());
            }
        } else {
            NxpNfcLogger.e(TAG, "DualAntenna handler is not initialized for antenna config");
        }
    }

    private void handleReaderModeConfiguration(
            int readerModeAntenna1Value, int readerModeAntenna2Value) {
        ...
        if (mDualAntennaHandler != null) {
            try {
                ...
                NxpNfcLogger.e(TAG, "Exception in reader mode configuration: " + e.getMessage());
            }
        } else {
            NxpNfcLogger.e(TAG, "DualAntenna handler is not initialized for reader mode config");
        }
    }
    ...
    private void handleGetDiscoveryTech() {
        ...
        if (mDualAntennaHandler != null) {
            try {
                int[] antennaConf = mDualAntennaHandler.getDiscoveryTechnology_DualAntenna();
            } catch (Exception e) {
                NxpNfcLogger.e(TAG, "Exception in get discovery tech " + e.getMessage());
            }
        } else {
            NxpNfcLogger.e(TAG, "DualAntenna handler is not initialized for get discovery tech");
        }
    }
    ...
    private void handleGetPollingMode() {
        ...
        if (mDualAntennaHandler != null) {
            ...
            NxpNfcLogger.e(TAG, "DualAntenna handler is not initialized for get polling mode");
        }
    }
